...
class Price():
    ...
    def __init__(self, currency: str, value: int, base_value: int, exchange_rates: dict[int]) -> None:
        if not currency:
    ...
    def exchange(self, exchange_currency: str) -> None:
        exchange_rate, exchange_base_value = self.__exchange_rates[
    ...
    def add(self, price_to_add, final_currency):
        ...
        final_price = Price(self.__currency, final_value,
                            self.__base_value, self.__exchange_rates)
